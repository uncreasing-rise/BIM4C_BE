...
const response = await fetch(`${base}/auth/login`, { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ email: value("ADMIN_BOOTSTRAP_EMAIL"), password: value("ADMIN_BOOTSTRAP_PASSWORD") }) });
...
const logout = await fetch(`${base}/auth/logout`, { method: "POST", headers: { cookie, origin: value("FRONTEND_URL") } });
