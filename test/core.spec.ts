...
describe('backend contract primitives', () => {
  ...
  it('reports quoted database URLs as configuration errors', () => { expect(() => validateEnvironment({ DATABASE_URL: '"postgresql://user:pass@localhost:5432/test"' })).toThrow(/Invalid environment: DATABASE_URL/); });
