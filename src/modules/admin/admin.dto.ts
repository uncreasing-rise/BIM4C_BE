...
export class CreateProjectDto extends OmitType(CreateContentDto, [
  'status',
] as const) {
...
export class BulkActionDto {
  ...
  @IsUUID('4', { each: true })
  ids!: string[];
  @IsIn(['publish', 'unpublish', 'archive', 'delete']) action!:
...
export class UpdateMediaDto {
  @IsOptional() @Transform(trim) @IsString() @MaxLength(240) alt?:
    string | null;
}
