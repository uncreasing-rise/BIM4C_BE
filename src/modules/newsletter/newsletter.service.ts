...
export class NewsletterService {
  ...
  async subscribe(
    ...
    await this.prisma.newsletterSubscription.upsert({
      ...
      create: { ...input, consentAt: new Date(), consentSource: 'website', isActive: true },
      update: { consent: true, consentAt: new Date(), privacyPolicyVersion: input.privacyPolicyVersion, consentSource: 'website', isActive: true, unsubscribedAt: null },
    });
