...
export class CreateHeroSlideDto {
  @IsString() @MinLength(2) @MaxLength(160) eyebrow!: string;
  @IsString() @MinLength(2) @MaxLength(240) title!: string;
  @IsString() @MinLength(2) @MaxLength(500) image!: string;
  @IsString() @MinLength(2) @MaxLength(240) alt!: string;
...
export class CreatePartnerDto {
  ...
  @IsString() @MinLength(2) @MaxLength(500) logo!: string;
